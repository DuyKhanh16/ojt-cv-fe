...
export default function SearchCandidate() {
  ...
  const Search = async () => {
    if (
      ...
      candidateSearch.location === "" &&
      candidateSearch.position === "" &&
      candidateSearch.level === ""
    ) {
  ...
  const chooseUser = async (id) => {
    if (role == 1) {
      navigate(`/candidate/candidate-outstanding/${id}`);
    } else if (role == 2) {
      navigate(`/company/candidate-outstanding-bybussiness/${id}`);
    }
  };
  return (
    <>
      <div className="searchCandidate__container">
        <div className="searchCandidate__container__header">
          ...
          <div className="searchCandidate__container__header__selectCity inputS">
            ...
            <select onChange={changeValue} name="location" id="">
          ...
          <div
            className="searchCandidate__container__header__button inputS"
            onClick={Search}
          >
            Tìm kiếm ngay
          </div>
                  ...
                  <div className="mainBusiness__outStandingCandidate--listCandidate__item__technical">
                    ...
                    <div className="mainBusiness__outStandingCandidate--listCandidate__item__technical__list">
                      {item?.skills_candidate?.map((item, index) => {
                        return (
                          <div
                            className="mainBusiness__outStandingCandidate--listCandidate__item__technical__list__item"
                            key={index}
                          >
                            {item.name}
                          </div>
