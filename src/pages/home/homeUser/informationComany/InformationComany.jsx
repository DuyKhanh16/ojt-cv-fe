  ...
  return (
    <>
      <div>
          ...
          <div className='user-companyView-info'>
            <div className='user-companyView-info-company'>
              ...
              <div style={{marginLeft:"24px"}}>
                <p className='user-companyView-info-company-name'>{companyDetail.nameCompany}</p>
                <p style={{marginLeft:"24px"}}>
                  <span className='user-companyView-info-company-type'>{companyDetail.typeCompany}</span> <span className='user-companyView-info-company-verified'>verified</span>
                </p>
                <p className='user-companyView-info-company-web'>
                  <i style={{color:"#BC2228"}} class="fa-solid fa-link"></i> {companyDetail.web}
                </p>
              </div>
            </div>
        ...
        <div className='user-companyView-describeMap' style={{display:"flex", width:"1320px", margin:"0 auto"}}>
          <div className='user-companyView-describe'>
            ...
            {companyDetail.describe.map((item, index) => {
              return <p style={{marginBottom:"16px"}} key={index}>{item}</p>;
            })}
            <p style={{fontWeight:"500", fontSize:"18px", color:"black"}}>Chính sách</p>
          ...
          <div className='user-companyView-orther'>
            <div className='user-companyView-orther-local'>
              <p className='user-companyView-orther-title'> <i class="fa-regular fa-compass"></i> Địa chỉ công ty</p>
              <p className='user-companyView-orther-address'>{companyDetail.address}</p>
            </div>
        ...
        <p style={{fontWeight:"500", fontSize:"18px", color:"black",marginLeft:"60px",marginBottom:"16px"}}>Việc công ty đang mở</p>
      ...
      <div style={{width:"100%",height:"1px", backgroundColor:"rgba(128, 128, 128, 0.314)", marginBottom:"100px"}}></div>
      <p style={{fontWeight:"400", fontSize:"40px", color:"#18191C",marginLeft:"60px",marginBottom:"50px"}}>Công ty cùng lĩnh vực</p>
