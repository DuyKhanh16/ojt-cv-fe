...
const updateCertificate = async () => {
  console.log(user)
  try {
    const create = await privateAxios.post(`api/v2/candidate/createCertificate`,user)
    ...
    <div style={{display:isOpen?'block':'none'}}>
      <div className="updateInforUser"  >
        ...
        <div className="updateInforUser__table certificate">
            ...
            <div>
              <p>Tổ chức</p>
              <input type="text" placeholder='ABCde' name="organization" onChange={(e)=>changeValue(e)} />
            </div>
